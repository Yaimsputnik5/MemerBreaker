# See https://github.com/Yaimsputnik5/MemerBreaker#getting-an-authorization-token
# for instructions on how to get a token.
#
# See https://github.com/Yaimsputnik5/MemerBreaker#enabling-discords-developer-mode
# for instructions on how to get a channel id.
#
# Detailed instructions on this config are available at
# https://github.com/Yaimsputnik5/MemerBreaker#configuration.
...
features:
  ...
  scratch:
    enable: true # Say Hello To My Little Friend!
    amount: 5000
    priority: true

  custom_commands:
  # These Will Be Ran Automatically, Periodically. Comment Out, Or Add Your Own To Be Auto-Ran!
  - value: "pls dep all" # Automatically Deposits All Your Money Currently In Your Wallet, To Your Bank (Check With pls bal)
  - value: "pls profile" # Automatically Checks Your Profile
  - value: "pls use apple" # Automatically Makes You Eat An Apple (Lasts 24 Hours), Preventing You From Losing Items Upon Dying. | Read: https://dank-memer-help.fandom.com/wiki/Apple
  #- value: "pls settings passive on" | Turns On Passive Mode (Disables Robbing, Bank Robbing | Read: https://dank-memer.fandom.com/wiki/Passive_mode)
  #- value: "pls se 5k" # Snake Eyes Dice Roll
  auto_buy:
    fishing_pole: true
    hunting_rifle: true
    laptop: true
    shovel: true
    padlock: false # Prevents People From Robbing You (Can Be Bypassed W/ Bolt Cutters | Read: https://dank-memer.fandom.com/wiki/Padlock & https://dank-memer.fandom.com/wiki/Bolt_Cutters) | Enable If On Passive | Read: https://dank-memer.fandom.com/wiki/Passive_mode
    landmine: false # Blows Up On Whoever Attempts To Rob You | Read: https://dank-memer-help.fandom.com/wiki/Landmine | Enable If On Passive | Read: https://dank-memer.fandom.com/wiki/Passive_mode
    lifesaver: false # Prevents You From Dying | Read: https://dank-memer.fandom.com/wiki/Life_Saver | Enable If On Passive | Read: https://dank-memer.fandom.com/wiki/Passive_mode
    apple: true # Automatically Makes You Buy An Apple (Lasts 24 Hours), Preventing You From Losing Items Upon Dying. | Read: https://dank-memer-help.fandom.com/wiki/Apple
  auto_sell:
    enable: true  # Automatically Goes Through And Sells The Items Below (If In Your Inventory). Feel Free To Add, Or Remove Whatever You Wish To Sell.
    items:
      - "boar"
      - "dragon"
      - "duck"
  ...
  auto_blackjack:
    enable: true # The Name's Bond... James Bond
    amount: 5000
    ...
    logic_table:
      ...
      A:
        ...
        soft20: "s"
  auto_tidepod:
    enable: false # Disable If On Passive | Read: https://dank-memer.fandom.com/wiki/Passive_mode
...
compatibility:
  ...
  allowed_hangman:
    ...
    - "Try hard, there is no cure for stupidity… yet"
